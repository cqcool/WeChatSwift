...
public class WXNavigationBarManger {
    ...
    var disableUINavigationControllers: Set<String> = []
    private init() {
    ...
    /// 启动 WXNavigationBar
    /// - Parameter disableUINavigationControllers: 启动WXNavigationBar的UINavigationController的名字 注意，传空时默认都启动
    public func setup(_ disableUINavigationControllers: Set<String> = []) {
        self.disableUINavigationControllers = disableUINavigationControllers
    }
}
